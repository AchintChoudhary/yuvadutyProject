    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8">
          ...
          {isMobileMenuOpen && (
            <div className="lg:hidden bg-white rounded-xl shadow-sm mb-4">
              <nav className="p-2">
                {tabs.map(tab => {
                  const IconComponent = tab.icon;
                  return (
          ...
          <div className="flex-1">
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm">
              ...
              <div className="hidden sm:block lg:hidden border-b border-gray-200">
              ...
              <div className="p-4 sm:p-6">
                ...
                {activeTab === 'overview' && (
                  <div className="space-y-4 sm:space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
                      <div className="bg-blue-50 rounded-lg sm:rounded-xl p-4">
                        <h3 className="font-semibold text-blue-900 mb-2 text-sm sm:text-base">Total Reports</h3>
                        <p className="text-2xl sm:text-3xl font-bold text-blue-600">{reportedProblems.length}</p>
                      </div>
                      <div className="bg-green-50 rounded-lg sm:rounded-xl p-4">
                        <h3 className="font-semibold text-green-900 mb-2 text-sm sm:text-base">Resolved</h3>
                        <p className="text-2xl sm:text-3xl font-bold text-green-600">
                          {reportedProblems.filter(p => p.status === 'resolved').length}
                        </p>
                      </div>
                      <div className="bg-yellow-50 rounded-lg sm:rounded-xl p-4">
                        <h3 className="font-semibold text-yellow-900 mb-2 text-sm sm:text-base">In Progress</h3>
                    ...
                    <div className="bg-gray-50 rounded-lg sm:rounded-xl p-4 sm:p-6">
                      <h3 className="font-semibold text-gray-900 mb-3 sm:mb-4 text-lg sm:text-xl">Personal Information</h3>
                      {isEditing ? (
                        ...
                        <div className="grid grid-cols-1 gap-3 sm:gap-4">
                          <div className="flex items-center space-x-3 py-2">
                            ...
                            <span className="text-gray-900 text-sm sm:text-base">{userInfo.name}</span>
                          </div>
                          <div className="flex items-center space-x-3 py-2">
                            <Mail className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 flex-shrink-0" />
                            <span className="text-gray-900 text-sm sm:text-base">{userInfo.email}</span>
                          </div>
                          <div className="flex items-center space-x-3 py-2">
                            <span className="text-gray-900 text-sm sm:text-base">{userInfo.phone}</span>
                          </div>
                          <div className="flex items-center space-x-3 py-2">
                            <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 flex-shrink-0" />
                            <span className="text-gray-900 text-sm sm:text-base">{userInfo.address}</span>
                          </div>
                        </div>
                      )}
                    </div>
                ...
                {activeTab === 'reports' && (
                  <div className="space-y-4">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                      <h3 className="font-semibold text-gray-900 text-lg sm:text-xl">My Reports</h3>
                      <button
                    ...
                    <div className="space-y-3">
                      {reportedProblems.map(problem => (
                        <div key={problem.id} className="border border-gray-200 rounded-lg p-3 sm:p-4 hover:bg-gray-50 transition-colors">
                          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                            <div className="flex-1">
                              <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-3 gap-2 mb-2">
                                <h4 className="font-medium text-gray-900 text-sm sm:text-base">{problem.title}</h4>
                ...
                {activeTab === 'locations' && (
                  <div className="space-y-4">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                      <h3 className="font-semibold text-gray-900 text-lg sm:text-xl">Saved Locations</h3>
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                            <div className="flex items-center space-x-3">
                              ...
                              <div className="min-w-0">
                                <h4 className="font-medium text-gray-900 text-sm sm:text-base truncate">{location.name}</h4>
                ...
                {activeTab === 'settings' && (
                  <div className="space-y-4 sm:space-y-6">
                    <div className="bg-gray-50 rounded-lg sm:rounded-xl p-4 sm:p-6">
                      <h3 className="font-semibold text-gray-900 mb-3 sm:mb-4 text-lg sm:text-xl">Notification Settings</h3>
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div className="flex-1 pr-4">
                            <h4 className="font-medium text-gray-900 text-sm sm:text-base">Email Notifications</h4>
                            <p className="text-xs sm:text-sm text-gray-600">Receive updates about your reports via email</p>
                          </div>
                          <input type="checkbox" className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 rounded" defaultChecked />
                        </div>
                        <div className="flex items-center justify-between">
                          <div className="flex-1 pr-4">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex-1 pr-4">
                            ...
                            <p className="text-xs sm:text-sm text-gray-600">Receive text messages for urgent updates</p>
                          </div>
                          <input type="checkbox" className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 rounded" />
                        </div>
                      </div>
                    </div>

                    <div className="bg-gray-50 rounded-lg sm:rounded-xl p-4 sm:p-6">
                      <h3 className="font-semibold text-gray-900 mb-3 sm:mb-4 text-lg sm:text-xl">Privacy Settings</h3>
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div className="flex-1 pr-4">
                            <h4 className="font-medium text-gray-900 text-sm sm:text-base">Public Profile</h4>
                            <p className="text-xs sm:text-sm text-gray-600">Allow others to see your profile and reports</p>
                          </div>
                          <input type="checkbox" className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 rounded" defaultChecked />
                        </div>
                        <div className="flex items-center justify-between">
                          <div className="flex-1 pr-4">
                            <h4 className="font-medium text-gray-900 text-sm sm:text-base">Location Sharing</h4>
                            <p className="text-xs sm:text-sm text-gray-600">Share your location for better problem reporting</p>
                          </div>
                          <input type="checkbox" className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 rounded" defaultChecked />
                        </div>
                      </div>
                    ...
                    <div className="bg-red-50 rounded-lg sm:rounded-xl p-4 sm:p-6">
                      <h3 className="font-semibold text-red-900 mb-3 sm:mb-4 text-lg sm:text-xl">Danger Zone</h3>
                      <div className="space-y-3">
                        ...
                        <button className="w-full flex items-center justify-center space-x-2 px-4 py-2 border border-red-300 text-red-600 rounded-lg hover:bg-red-50 transition-colors text-sm sm:text-base">
                          <Trash2 className="w-4 h-4" />
